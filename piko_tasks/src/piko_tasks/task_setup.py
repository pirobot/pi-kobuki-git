...
#     self.waypoints.append(Pose(Point(0.0, self.square_size, 0.0), quaternions[2]))
    ...
    self.waypoints.append(Pose(Point(-0.269, 0.660, 0.000), Quaternion(0.000, 0.000, 1.0, 0.0)))
    self.waypoints.append(Pose(Point(-1.207, 0.722, 0.000), Quaternion(0.000, 0.000, 0.983, 0.184)))
    self.waypoints.append(Pose(Point(-1.424, -1.213, 0.000), Quaternion(0.000, 0.000, 0.998, -0.066)))
