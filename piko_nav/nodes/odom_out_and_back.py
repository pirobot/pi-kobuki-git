...
class OutAndBack():
    def __init__(self):
        ...
        # Set the linear tolerance in meters
        linear_tolerance = rospy.get_param('~linear_tolerance', 0.02)
        
        # Set the angular tolerance in degrees converted to radians
        angular_tolerance = radians(rospy.get_param('~angular_tolerance', 1.0))
        ...
        for i in range(2):
            ...
            while abs(error) > linear_tolerance and not rospy.is_shutdown():
                ...
                move_cmd.linear.x = copysign(linear_speed, error)
            ...
            error = goal_angle - turn_angle
            
            while abs(error) > angular_tolerance and not rospy.is_shutdown():
                # Rotate to reduce the rror
                move_cmd.angular.z = copysign(angular_speed, error)
